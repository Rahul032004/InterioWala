...
// Use schema from global window object
// This will be populated by schema.js
const schema = window.schemaModule;

// Helper function for deep comparison of objects (for complex queries)
function deepCompare(itemValue, queryValue) {
...
function fromObjectIdArray(docs) {
  if (!docs) return [];
